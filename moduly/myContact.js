...
//GET WYSYŁANY JAKO ZAPYTANIE KONTAKTU
const idContact = `b20a82206`;
const options = {
  host: 'api.linkedin.com',
  path: `/v2/people/(id:${idContact})`,//pobranie uzytkownika o podanym id
  method: 'GET',
  headers: {
...
exports.profileRequestContact = https.request(options, function(res) {
  let data = '';
  res.on('data', (chunk) => {
    data += chunk;
  });
